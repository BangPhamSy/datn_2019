...
--
-- Host: localhost
-- Generation Time: Mar 23, 2019 at 03:10 PM
...
INSERT INTO `classes` (`id`, `name`, `status`, `schedule`, `time_start`, `duration`, `teacher_id`, `course_id`, `class_size`, `class_code`, `start_date`, `created_at`, `updated_at`) VALUES
(1, 'ssadasdas', 0, '3,4,', '00:22:00', 20, 1, 1, 56, 'Haaaaaa', '2019-03-13', '2019-03-11 23:35:08', NULL),
(2, 'IELTS Foundation', 1, '3,5,', '00:22:00', 20, 1, 1, 30, 'IELTS12', '2019-03-20', '2019-03-12 00:01:07', NULL),
(3, 'Lop test', 1, '4,5,', '00:00:00', 20, 1, 1, 50, '12345678', '2019-03-13', '2019-03-12 00:22:52', NULL),
(4, 'âásss', 1, '3,', '07:00:00', 10, 1, 1, 20, 'aas', '2019-03-13', '2019-03-12 00:28:33', NULL),
(5, 'kkklslslsls', 0, '3,', '11:00:00', 2, 1, 1, 30, 'abc', '2019-03-13', '2019-03-12 00:30:26', NULL),
(6, 'TOEIC cho người mất gốc', 0, '1,', '12:00:00', 2, 1, 1, 30, '109822', '2019-06-24', '2019-03-23 01:43:19', NULL);
...
INSERT INTO `teachers` (`id`, `name`, `birthdate`, `mobile`, `address`, `experience`, `certificate`, `description`, `created_at`, `updated_at`, `gender`, `user_id`) VALUES
(1, 'ssss', '1987-02-05', '113', 'sss', 2, 'sss', 'sss', NULL, NULL, 1, 3);
