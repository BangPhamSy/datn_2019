$(function () {
	    ...
	    columns: [
        	...
        	},
            {
                ...
                'render': function (data, type, row) {
					...
					'</button> <button studentID=\"'+row.id+'\" title=\"Xem kết quả học tập\"'+
                    'class=\"btn btn-success StudentShowAchieve\"><i class=\"fa fa-trophy\"aria-hidden=\"true\"></i>'+
	...
	//Xem kết quả học tập học viên
	$(document).on('click', '.StudentShowAchieve', function(){
		IDstudent = $(this).attr('studentID');
		// var student_id = $('#get_student_id2').val(IDstudent);
		// console.log(IDstudent);
    	
		$('#modal-show-achieve').modal('show');
